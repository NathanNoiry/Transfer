...
list_mse_std_ols = []
for param in grid_param:
    df = pd.read_csv('./results/transfer_ols_1000000_'+param+'_100_100.csv')
...
list_mse_std_svr = []
for param in grid_param:
    df = pd.read_csv('./results/transfer_svm_1000000_'+param+'_100_100.csv')
...
list_mse_std_rf = []
for param in grid_param:
    df = pd.read_csv('./results/transfer_rf_1000000_'+param+'_100_100.csv')
